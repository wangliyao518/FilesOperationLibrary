...
class TestKissFilesInterfaceXML(unittest.TestCase):
    def setUp(self):
    ...
    def _test__setup_and_teardown_scfc(self):
    ...
    def test__modify_scfc_text(self):
        ...
        self.xml_operator.modify_xml_text('.//managedObject[@className="TEST:L2BTS"]/p[@name="active1xCsfb"]:true',
                                          './/managedObject[@className="TEST:L2BTS"]/list[@name="amRlcPBTab2"]/item/p[@name="dlPollByte"]:666kB')

        result = self.xml_operator.read_xml_text('.//managedObject[@className="TEST:L2BTS"]/p[@name="active1xCsfb"]')[0]
        self.assertEqual(result, 'true')
        result = self.xml_operator.read_xml_text(
            './/managedObject[@className="TEST:L2BTS"]/list[@name="amRlcPBTab2"]/item/p[@name="dlPollByte"]')[0]
        self.assertEqual(result, '666kB')

        self.xml_operator.modify_xml_text('.//managedObject[@className="TEST:L2BTS"]/list[@name="cipherPre"]/item/p[@name="eea0"]:1000')
    
        result = self.xml_operator.read_xml_text('.//managedObject[@className="TEST:L2BTS"]/list[@name="cipherPre"]/item/p[@name="eea0"]')[0]
    ...
    def _test__read_PM_text(self):
        ...
        result = self.xml_operator.read_xml_text("//*[text()='PLLEN-PLLEN/LERWTS-1/LNWTS-1/LNCEL-1']/../..//LE2018C500")[0]
...
# class _TestKissFilesInterfaceTXT(unittest.TestCase):
#     def setUp(self):
...
#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"))
#         self.txt_operator.teardown_txt()

#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"),
#                                     os.path.join(BASE_NAME, "profile_test.txt"))
#         self.txt_operator.teardown_txt()

#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"),
#                                     os.path.join(BASE_NAME, "profile_test1.txt"),
#                                     alias='test')
...
#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"),
#                                     os.path.join(BASE_NAME, "profile_test2.txt"))
...
#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"),
#                                     os.path.join(BASE_NAME, "profile_test3.txt"))
...
#         self.txt_operator.setup_txt(os.path.join(BASE_NAME, "profile.txt"),
#                                     os.path.join(BASE_NAME, "profile_test4.txt"))
...
# class _TestFtpDownloadUpload(unittest.TestCase):
#     def setUp(self):
...
# class _TestKissFilesInterfaceCSV(unittest.TestCase):
#     def setUp(self):
...
# class _TestKissFilesInterfaceBIN(unittest.TestCase):
#     def setUp(self):
#         self.bin_operator = OperateBin()
#         self.file = open(os.path.join(BASE_NAME, "bin4test.BIN"), 'r+b')
...
#         self.assertEqual(
#             self.bin_operator.read_bin_file(os.path.join(BASE_NAME, "bin4test.BIN"), "SwVersion"),
#             'D406900')
#         self.assertEqual(
#             self.bin_operator.read_bin_file(os.path.join(BASE_NAME, "bin4test.BIN"), "HwVersion"),
#             'NOT FOUND')

#     def test__modify_bin_file(self):
#         self.bin_operator.modify_bin_file(os.path.join(BASE_NAME, "bin4test.BIN"), "TargetUnit", "FSMF")
#         self.assertEqual(
#             self.bin_operator.read_bin_file(os.path.join(BASE_NAME, "bin4test.BIN"), "TargetUnit"),
#             'FSMF')
#         self.assertEqual(
#             self.bin_operator.modify_bin_file(os.path.join(BASE_NAME, "bin4test.BIN"), "TargetUnit", "FSPMF"),
#             'Fail to modify')


# class _TestKissFilesInterfaceXLS(unittest.TestCase):
#     def setUp(self):
...
# class _TestKissFilesInterfaceUnzip(unittest.TestCase):
#     def setUp(self):
...
# class _TestKissFilesInterfaceLOG(unittest.TestCase):
#     def setUp(self):
#         self.log_operator = OperateLog()
#         pass

#     def test__unzip_file(self):
#         self.log_operator.split_iphy_log_by_ueid(os.path.join(BASE_NAME, "message.log"))
#         self.log_operator.split_iphy_log_by_ueid(os.path.join(BASE_NAME, "message_UErelease.log"))
